...
var TimePickerSelect = /*#__PURE__*/React__default.forwardRef(function TimePickerSelect(_ref, ref) {
  ...
  var selectClasses = cx(_objectSpread2((_objectSpread2$1 = {}, _defineProperty(_objectSpread2$1, "".concat(prefix, "--select"), true), _defineProperty(_objectSpread2$1, "".concat(prefix, "--time-picker__select"), true), _objectSpread2$1), className && _defineProperty({}, className, true)));
