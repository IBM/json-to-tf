...
var TimePicker = /*#__PURE__*/React__default.forwardRef(function TimePicker(_ref, ref) {
  var _objectSpread2$1, _cx2;
  ...
  var timePickerClasses = cx(_objectSpread2((_objectSpread2$1 = {}, _defineProperty(_objectSpread2$1, "".concat(prefix, "--time-picker"), true), _defineProperty(_objectSpread2$1, "".concat(prefix, "--time-picker--light"), light), _defineProperty(_objectSpread2$1, "".concat(prefix, "--time-picker--invalid"), invalid), _defineProperty(_objectSpread2$1, "".concat(prefix, "--time-picker--readonly"), readOnly), _defineProperty(_objectSpread2$1, "".concat(prefix, "--time-picker--").concat(size), size), _objectSpread2$1), className && _defineProperty({}, className, true)));
  ...
  function getInternalPickerSelects() {
    ...
    var mappedChildren = React__default.Children.map(children, function (pickerSelect) {
