...
var Selection = /*#__PURE__*/function (_React$Component) {
  _rollupPluginBabelHelpers.inherits(Selection, _React$Component);

  var _super = _rollupPluginBabelHelpers.createSuper(Selection);

  function Selection(props) {
    var _this;

    _rollupPluginBabelHelpers.classCallCheck(this, Selection);

    _this = _super.call(this, props);

    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "internalSetState", function (stateToSet, callback) {
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "handleClearSelection", function () {
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "handleSelectItem", function (item) {
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "handleRemoveItem", function (index) {
      _this.internalSetState(function (state) {
        return {
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "handleOnItemChange", function (item) {
      if (_this.props.disabled) {
        return;
      }
  ...
  _rollupPluginBabelHelpers.createClass(Selection, [{
    key: "render",
