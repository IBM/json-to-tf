...
var hasChangeInOffset = function hasChangeInOffset() {
  ...
  if (_rollupPluginBabelHelpers["typeof"](oldMenuOffset) !== _rollupPluginBabelHelpers["typeof"](menuOffset)) {
    return true;
  }
...
var getFloatingPosition = function getFloatingPosition(_ref) {
  ...
  return (_DIRECTION_LEFT$DIREC = {}, _rollupPluginBabelHelpers.defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_LEFT, function () {
    return {
      left: refLeft - width + scrollX - left - relativeDiff.left,
      top: refCenterVertical - height / 2 + scrollY + top - 9 - relativeDiff.top
    };
  }), _rollupPluginBabelHelpers.defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_TOP, function () {
    return {
      left: refCenterHorizontal - width / 2 + scrollX + left - relativeDiff.left,
      top: refTop - height + scrollY - top - relativeDiff.top
    };
  }), _rollupPluginBabelHelpers.defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_RIGHT, function () {
    return {
      left: refRight + scrollX + left - relativeDiff.left,
      top: refCenterVertical - height / 2 + scrollY + top + 3 - relativeDiff.top
    };
  }), _rollupPluginBabelHelpers.defineProperty(_DIRECTION_LEFT$DIREC, DIRECTION_BOTTOM, function () {
    return {
      left: refCenterHorizontal - width / 2 + scrollX + left - relativeDiff.left,
...
var FloatingMenu = /*#__PURE__*/function (_React$Component) {
  _rollupPluginBabelHelpers.inherits(FloatingMenu, _React$Component);
  ...
  function FloatingMenu() {
    ...
    _rollupPluginBabelHelpers.classCallCheck(this, FloatingMenu);
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "_placeInProgress", false);
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "_menuContainer", null);

    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "_menuBody", null);
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "_updateMenuSize", function () {
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "_focusMenuContent", function (menuBody) {
      var primaryFocusNode = menuBody.querySelector(_this.props.selectorPrimaryFocus || null);
      var tabbableNode = menuBody.querySelector(navigation.selectorTabbable);
      var focusableNode = menuBody.querySelector(navigation.selectorFocusable);
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "_menuRef", function (menuBody) {
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "_getChildrenWithProps", function () {
      ...
      return /*#__PURE__*/React__default["default"].cloneElement(children, {
        ref: _this._menuRef,
        style: _rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, styles), positioningStyle), {}, {
          position: 'absolute',
          opacity: 1
        })
      });
    ...
    _rollupPluginBabelHelpers.defineProperty(_rollupPluginBabelHelpers.assertThisInitialized(_this), "handleBlur", function (_ref2) {
  ...
  _rollupPluginBabelHelpers.createClass(FloatingMenu, [{
