...
var ListBox = /*#__PURE__*/React__default["default"].forwardRef(function ListBox(_ref, ref) {
  ...
  var className = cx__default["default"](_rollupPluginBabelHelpers.objectSpread2(_rollupPluginBabelHelpers.objectSpread2({}, containerClassName && _rollupPluginBabelHelpers.defineProperty({}, containerClassName, true)), {}, (_objectSpread2 = {}, _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box"), true), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box--").concat(size), size), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box--inline"), type === 'inline'), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box--disabled"), disabled), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box--light"), light), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box--expanded"), isOpen), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box--invalid"), invalid), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--list-box--warning"), showWarning), _objectSpread2)));
