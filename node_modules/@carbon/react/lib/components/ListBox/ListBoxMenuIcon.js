...
var defaultTranslations = (_defaultTranslations = {}, _rollupPluginBabelHelpers.defineProperty(_defaultTranslations, translationIds['close.menu'], 'Close menu'), _rollupPluginBabelHelpers.defineProperty(_defaultTranslations, translationIds['open.menu'], 'Open menu'), _defaultTranslations);
...
var ListBoxMenuIcon = function ListBoxMenuIcon(_ref) {
  ...
  var className = cx__default["default"]("".concat(prefix, "--list-box__menu-icon"), _rollupPluginBabelHelpers.defineProperty({}, "".concat(prefix, "--list-box__menu-icon--open"), isOpen));
