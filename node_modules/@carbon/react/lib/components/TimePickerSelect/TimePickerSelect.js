...
var TimePickerSelect = /*#__PURE__*/React__default["default"].forwardRef(function TimePickerSelect(_ref, ref) {
  ...
  var selectClasses = cx__default["default"](_rollupPluginBabelHelpers.objectSpread2((_objectSpread2 = {}, _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--select"), true), _rollupPluginBabelHelpers.defineProperty(_objectSpread2, "".concat(prefix, "--time-picker__select"), true), _objectSpread2), className && _rollupPluginBabelHelpers.defineProperty({}, className, true)));
