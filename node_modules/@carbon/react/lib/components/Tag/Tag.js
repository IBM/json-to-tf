...
var Tag = function Tag(_ref) {
  ...
  var tagClasses = cx__default["default"]("".concat(prefix, "--tag"), className, (_classNames = {}, _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--tag--disabled"), disabled), _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--tag--filter"), filter), _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--tag--").concat(size), size), _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--tag--").concat(type), type), _rollupPluginBabelHelpers.defineProperty(_classNames, "".concat(prefix, "--tag--interactive"), other.onClick && !filter), _classNames));
