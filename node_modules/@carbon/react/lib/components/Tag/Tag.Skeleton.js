...
function TagSkeleton(_ref) {
  ...
  return /*#__PURE__*/React__default["default"].createElement("span", _rollupPluginBabelHelpers["extends"]({
    className: cx__default["default"]("".concat(prefix, "--tag"), "".concat(prefix, "--skeleton"), className, _rollupPluginBabelHelpers.defineProperty({}, "".concat(prefix, "--tag--").concat(size), size))
  }, rest));
}
