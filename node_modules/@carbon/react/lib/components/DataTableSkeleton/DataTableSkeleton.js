...
var DataTableSkeleton = function DataTableSkeleton(_ref) {
  ...
  var dataTableSkeletonClasses = cx__default["default"](className, (_cx = {}, _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(prefix, "--skeleton"), true), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(prefix, "--data-table"), true), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(prefix, "--data-table--zebra"), zebra), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(prefix, "--data-table--compact"), compact), _cx));
