...
var Stack = /*#__PURE__*/React__default["default"].forwardRef(function Stack(props, ref) {
  ...
  var className = cx__default["default"](customClassName, (_cx = {}, _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(prefix, "--stack-").concat(orientation), true), _rollupPluginBabelHelpers.defineProperty(_cx, "".concat(prefix, "--stack-scale-").concat(gap), typeof gap === 'number'), _cx));
  var style = {};
