...
var SideNavItems = function SideNavItems(_ref) {
  ...
  var className = cx__default["default"](["".concat(prefix, "--side-nav__items")], customClassName);
  var childrenWithExpandedState = React__default["default"].Children.map(children, function (child) {
    if ( /*#__PURE__*/React__default["default"].isValidElement(child)) {
      var _child$type;

      // avoid spreading `isSideNavExpanded` to non-Carbon UI Shell children
      return /*#__PURE__*/React__default["default"].cloneElement(child, _rollupPluginBabelHelpers.objectSpread2({}, _utils.CARBON_SIDENAV_ITEMS.includes((_child$type = child.type) === null || _child$type === void 0 ? void 0 : _child$type.displayName) ? {
