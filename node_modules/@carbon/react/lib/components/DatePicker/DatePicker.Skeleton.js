...
var DatePickerSkeleton = function DatePickerSkeleton(_ref) {
  ...
  if (range) {
    return /*#__PURE__*/React__default["default"].createElement("div", {
      ...
      className: cx__default["default"]("".concat(prefix, "--date-picker"), "".concat(prefix, "--date-picker--range"), "".concat(prefix, "--skeleton"), className)
  ...
  return /*#__PURE__*/React__default["default"].createElement("div", {
    ...
    className: cx__default["default"]("".concat(prefix, "--date-picker"), "".concat(prefix, "--date-picker--short"), "".concat(prefix, "--date-picker--simple"), "".concat(prefix, "--skeleton"), className)
  }, rest), dateInput));
};
